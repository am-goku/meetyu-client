...
function TextBox({ user, seen = false, message }) {
                ...
                <p>10:30pm</p>
                {
                    user && (
                        seen ? <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="15" height="15" viewBox="0 0 24 24">
                            ...
                            <svg fill="#000000" viewBox="0 0 32 32" width={15} height={15} xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16,32A16,16,0,1,0,0,16,16,16,0,0,0,16,32ZM16,2A14,14,0,1,1,2,16,14,14,0,0,1,16,2Z"></path> </g></svg>
                    )
                }
            </div>
        </div>
